...
import ListData from "@/layoutC23-L3-AA/listData.json"
type myProps = {
  ...
  return (
    <div className="grid grid-cols-12 place-items-center gap-5  w-[900px]  p-1">
     ...
     <div className="col-span-12 w-full flex justify-start p-5 items-center flex-col gap-3 bg-violet-200 min-h-[300px] rounded-lg">
      <h2 className="text-2xl text-black font-semibold"> Read the  Personal bill of rights</h2>
      ...
      <h2 className="text-md text-black font-semibold"> Source: Cited from Anxiety and Phobia Workbook by Edmund J. Bourne
</h2>
     </div>
