...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col gap-4 items-center justify-start  bg-[url(/images/bg_image.jpg)] bg-fixed bg-cover bg-center p-5">
    <h5 className="text-[50px] py-5 text-red-600">Module 3 PDF Activities</h5>
